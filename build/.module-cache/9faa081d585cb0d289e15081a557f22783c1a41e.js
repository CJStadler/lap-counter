    ...
    return (
      React.createElement(ReactCSSTransitionGroup, {transitionName: "example"}, 
        this.state.athletes.map(function(athlete, i) {
            return React.createElement(Athlete, {onClick: this.handleClick.bind(this, i), athlete: athlete, key: athlete.hip_number+" "+athlete.laps});
        }.bind(this))
      )
    );
  }
...
React.render(
  React.createElement(List, {total_laps: 5, athletes: test_data}), document.getElementById('container')
);